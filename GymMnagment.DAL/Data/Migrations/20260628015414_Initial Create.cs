...
namespace GymMnagment.DAL.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneCheck", "Phone LIKE '01%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneCheck1", "Phone LIKE '01%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("SesstionCapacityCheck", "Capacity Between 1 and 25");
                    table.CheckConstraint("SesstionEndDateCheck", "EndDate > StartDate");
                    table.ForeignKey(
